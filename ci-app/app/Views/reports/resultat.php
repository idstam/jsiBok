...
{ ?>
    <tr>
            ...
            <td class="number" style="font-weight: bold;"><?= format_bc($in_amount_sum2) ?></td>
            <td class="number" style="font-weight: bold;"><?= format_bc($p_amount_sum2) ?></td>
            <td class="number" style="font-weight: bold;"><?= format_bc($ut_amount_sum2) ?></td>
    </tr>
...
<!--    </thead>-->
    ...
    foreach ($reportQuery as $row) {
        ...
        $in_amount = bcmul($in_amount, -1, 2);
        $p_amount = bcadd($row->p_amount, '0', 2);
        $p_amount = bcmul($p_amount, -1, 2);
...
//        $kredit = bcmul($row->kredit, '1', 2);
    ...
    <tr>
        <td>
            <h3 style="font-weight: bold;">Totalt resultat</h3>
        </td>
        <td class="number">
            <h3 style="font-weight: bold;"><?= format_bc($in_amount_sum0) ?></h3>
        </td>
        <td class="number">
            <h3 style="font-weight: bold;"><?= format_bc($p_amount_sum0) ?></h3>
        </td>
        <td class="number">
            <h3 style="font-weight: bold;"><?= format_bc($ut_amount_sum0) ?></h3>
        </td>
    </tr>
